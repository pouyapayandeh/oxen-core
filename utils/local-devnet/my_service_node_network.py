...
class SNNetwork:
    def __init__(self, datadir, *, binpath='/home/pouya/projects/sarbazi/oxen-core/build/Linux/stable/debug/bin', sns=8, nodes=3):
        ...
        self.sync_nodes(self.mine(50), timeout=120)
        self.print_wallet_balances()
